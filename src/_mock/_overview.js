...
const TITLES = ['SandBox Avatar v1.0', 'SandBox Land v1.0', 'Assets Costume Management'];
const DESCRIPTION = [
  'Tool for test assets in avatar',
  'Tool for publish verse',
  'Create and publish in verse',
];
export const _appFeatured = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
  title: TITLES[index], // _mock.postTitle(index),
  description: DESCRIPTION[index], // _mock.sentence(index),
  coverUrl: _mock.image.feed(index),
}));
